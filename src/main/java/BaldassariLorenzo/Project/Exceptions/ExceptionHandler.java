...
import BaldassariLorenzo.Project.Payloads.ErrorPayloads.ErrorDto;
...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(TicketExaustedException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)

    public ErrorDto handleNoTicketException(Exception ex) {
        return new ErrorDto("posti esauriti per questo evento mi dispiace!", LocalDateTime.now());
    }
